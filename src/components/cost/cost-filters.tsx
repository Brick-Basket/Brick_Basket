...
/** Category + project filters for the Project Cost Accounting list, mirroring `ACEFilters`. */
export function CostFilters({ value, onChange }: { value: CostListParams; onChange: (next: CostListParams) => void }) {
